    ...
    <div>
        <div class="product-info">
            <div class="product-image">
                <img :src=" mainproduct.image" alt="Product Image">
            </div>
...
export default {
    ...
    computed : {
        ...
        mainproduct(){
            ...
            console.log("nebuneee", products[productid].filter(item=> {return item.id == this.selectedCategory }))
            return products[productid].find(item=> {return item.id == this.selectedCategory });
        },

        ads() {
      return products[this.selectedCategory];
    },
    selectedCategory() {
